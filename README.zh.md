...
<p align="center">
  <strong>一款全局 AI 语音输入法，为你解决两个核心痛点。</strong><br>
  <strong>痛点 1：打字慢、改稿烦。</strong>按下快捷键说话， AI 即刻完成高精度识别、帮你把口语转换为书面文字并修正标点，松开按键直接自动粘贴，全程不切窗口。<br>
  <strong>痛点 2：语音上传云端泄露隐私。</strong>内置本地大语言模型，音频和文字全程从不离开设备，商业机密、会议内容等敏感信息绝不泄露。
</p>
