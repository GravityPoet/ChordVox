...
export default defineConfig(({ mode }) => {
  ...
  const rawPort =
    env.VITE_DEV_SERVER_PORT || env.CHORDVOX_DEV_SERVER_PORT || env.OPENWHISPR_DEV_SERVER_PORT
  ...
  return {
    plugins: [
      ...
      tailwindcss(),
      {
        ...
        writeBundle() {
          const runtimeEnv = {
            VITE_CHORDVOX_API_URL: env.VITE_CHORDVOX_API_URL || env.VITE_OPENWHISPR_API_URL || '',
            VITE_OPENWHISPR_API_URL: env.VITE_OPENWHISPR_API_URL || env.VITE_CHORDVOX_API_URL || '',
