...
import DictationCommandMenu from "./components/DictationCommandMenu.tsx";
...
const configuredChannel = (
  import.meta.env.VITE_CHORDVOX_CHANNEL ||
...
const OAUTH_PROTOCOL = (
  import.meta.env.VITE_CHORDVOX_PROTOCOL ||
...
const OAUTH_AUTH_BRIDGE_URL = (
  import.meta.env.VITE_CHORDVOX_AUTH_BRIDGE_URL ||
      ...
      <div id="oauth-container" role="status" aria-live="polite">
        <div class="auth-card">
          <div class="logo-wrapper">
            <svg class="logo" viewBox="0 0 1024 1024" width="64" height="64" aria-label="ChordVox">
...
function AppRouter() {
  ...
  const isCommandMenu = window.location.search.includes("commandMenu=true");
  const isDictationPanel = !isControlPanel && !isCommandMenu;
