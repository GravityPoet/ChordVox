...
ChordVox is an Electron-based desktop dictation application that uses whisper.cpp for speech-to-text transcription. It supports both local (privacy-focused) and cloud processing modes.
...
3. `gnomeShortcut.js` creates the current D-Bus service at `com.chordvox.App`
