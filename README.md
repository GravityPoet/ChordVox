...
<p align="center">
  <strong>一款能听懂您说话的全局 AI 智能输入法。<br>对准麦克风开口，它就能用AI将您的语音转化为精修文字，并瞬间粘贴进任意软件的光标位置。<br>支持本地私密部署，音频绝不上传云端，彻底解放您的双手，让大脑跟上语速。</strong>
</p>
...
> **按下快捷键说话，松手即刻变成完美排版好的文字并自动粘贴到您当前的输入框。内置本地大模型，无需联网也可保证绝对隐私。**
