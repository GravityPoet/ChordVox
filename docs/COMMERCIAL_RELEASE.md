...
Every customer-facing GitHub Release description must include the exact macOS unblock command block above.
...
- Storage: SQLite
- Admin tooling: issue/revoke/list/reset-activation via CLI
- Policy: single-device enforced (`1 key = 1 device`)
