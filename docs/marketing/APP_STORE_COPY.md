...
- AI 文本润色：即刻自动剔除语气词并修正语法。
- 原生无缝集成：在任何应用（微信、邮件或备忘录）的光标处直接生效。
- 隐私安全优先：无云端处理，无数据采集。你的语言只属于你自己。
...
- AI Text Refinement: Automatically removes filler words and fixes grammar on the fly.
- Native Integration: Works right at your cursor in any app, messages, emails, or notes.
- Privacy-First: No cloud processing, no data harvesting. Your words belong to you.
